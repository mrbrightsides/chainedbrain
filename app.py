...
with st.sidebar:
    ...
    **ChainedBrain** is an AI-powered multiplayer quiz platform where brains connect through the chain.
    ...
    Create engaging quizzes instantly with AI or build them from scratch, then challenge friends in real-time multiplayer sessions or explore the public gallery for solo play.
    ...
    - ⭐ **Star / Fork**: [GitHub repo](https://github.com/mrbrightsides/chainedbrain)
...
# URL Ohara
iframe_url = "https://chainedbrain.elpeef.com/"
